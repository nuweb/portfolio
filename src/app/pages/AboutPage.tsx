...
export function AboutPage() {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20 bg-warm-50 dark:bg-navy-950">
      <div className="max-w-2xl text-center">
        ...
        {/* Title */}
        <p className="text-xl text-warm-600 dark:text-navy-300 mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {skills.map((skill) => (
            <span
              key={skill}
              className="px-4 py-2 bg-warm-200 dark:bg-navy-800 text-warm-600 dark:text-navy-300 rounded-full text-sm font-medium"
            >
              {skill}
            </span>
          ))}
        ...
        <div className="flex items-center justify-center gap-6 mb-8">
          <a
            ...
            className="text-warm-400 dark:text-navy-400 hover:text-warm-600 dark:hover:text-white transition-colors"
          >
